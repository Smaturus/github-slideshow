...
PLACE_CANONICAL = {
  ...
  # Химки
    "химки": "г. Химки, Московская область",
    "гхимки": "г. Химки, Московская область",
    "химки, московская область, россия": "г. Химки, Московская область",
  # Москва
    "москва": "Москва",
    "гмосква": "Москва",
  ...
  # Чистополь
    "чистополь": "г. Чистополь, Татария",
    "гчистополь": "г. Чистополь, Татария",
  # Толкиш
    "толкиш, татария": "с. Толкиш, Татария",
    "малый толкиш": "с. Толкиш, Татария",
  # Новошешминск
    "новошешминск": "с. Новошешминск, Татария",
  # Лозовая Павловка
  ...
  # Валдай / Серганиха
    "дер.серганиха валдайского уезда новгородской губернии": "дер. Серганиха, Валдайский уезд, Новгородская губерния",
    "г.валдай": "г. Валдай, Новгородская губерния",
  # Солнечногорск
    "солнечногорск": "г. Солнечногорск, Московская область",
    "гсолнечногорск": "г. Солнечногорск, Московская область",
  # Борисоглебск
    "борисоглебск": "г. Борисоглебск",
    "гборисоглебск": "г. Борисоглебск",
  # Астрахань
    "астрахань": "Астрахань",
    "астраххань": "Астрахань",
  # Донбасс
    "донецкая область": "Донецкая область",
    "константиновка донецкой обл": "Константиновка, Донецкая область",
}
