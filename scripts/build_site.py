...
SURNAME_NOTES = {
    ...
    "Захаров": "Род из Толкиша (Татария); Григорий Спиридонович писался и Захаровым, и Алексеевым — отсюда ветвь Алексеевых.",
    "Алексеев": "Ветвь Захаровых из Толкиша, закрепившая второе написание фамилии; Новошешминск, Чистополь.",
  ...
  <div class="wrap">
    ...
    <div class="grid g2" style="margin-bottom:44px">
      ...
      <div class="card">
        ...
        <p>Донбасская ветвь: род из села <b>Лозовая Павловка</b> (ныне Луганщина). Дед <b>Алексей Скиба</b> (1907, Лозовая Павловка — 1955, Химки), прадед <b>Григорий</b> (р. 1879), прапрадед <b>Андрей Скиба</b>.</p>
      ...
      <div class="card">
        ...
        <p>Бабушка <b>Нина Поташкина</b> (1938, Торопец): отец — <b>Федор Поташкин</b> с Валдая, мать — <b>Серафима Алексеева</b> из Чистополя. Через Алексеевых линия уходит в Толкиш — к <b>Захаровым</b> и <b>Елисеевым</b>.</p>
