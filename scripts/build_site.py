...
SURNAME_NOTES = {
    "Матюхин": "Русская фамилия; в селе Мокрое Тульской области прослеживается с XIX века.",
...
<div class="hero">
  <div class="wrap">
    ...
    <p class="sub">Две главные линии — <b>Матюхины</b> из села Мокрое Тульской губернии и <b>Скибы</b> из Астрахани — сошлись в семье Сергея и Надежды. Подмосковье и Поволжье, уральские и астраханские ветви; {st['people']} человек в базе, {st['surnames']} фамилий, {documented_gens} поколений прослежено.</p>
  ...
  <div class="wrap">
    ...
    <div class="grid g2">
      ...
      <div class="scard">
        ...
        <ul>
          <li>Метрики по <b>с. Мокрое</b> Белевского уезда (ГАТО)</li>
